...
if test_alternate:
  ...
  solved = 0; unsolved = []; benchmark = 12; timebound = 1.3 #time limit
...
if test_anytime_gbfs:
  ...
  solved = 0; unsolved = []; benchmark = 0; timebound = 1 #2 second time limit
  for i in range(0, len(PROBLEMS)):
    print("*************************************")  
    print("PROBLEM {}".format(i))
...
if test_anytime_weighted_astar:
  ...
  solved = 0; unsolved = []; benchmark = 0; timebound = 0.8 #2 second time limit
  for i in range(0, len(PROBLEMS)):
    # print("*************************************")
    # print("PROBLEM {}".format(i))
